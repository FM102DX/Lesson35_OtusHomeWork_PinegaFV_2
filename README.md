## Домашняя работа по клиент-серверному взаимодействию  
Консольное приложение общается с веб-сервисом, происходит CRUD сущности Customer.  
[Видеопрезентация](https://disk.yandex.ru/i/YwAuhagxArIieQ)  

Ниже приведен оригинальный текст домашнего задания.
